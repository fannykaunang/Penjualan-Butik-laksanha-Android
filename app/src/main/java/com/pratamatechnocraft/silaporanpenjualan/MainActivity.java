...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, DateRangePickerFragment.OnDateRangeSelectedListener {
    ...
    private static final String API_URL_LOAD = "CheckRegisteredUser/GetRegisteredUser?";
...
//        if (user.get(sessionManager.LEVEL_USER) == "Administrator"){
        ...
        //Toast.makeText(MainActivity.this, user.get(sessionManager.LEVEL_USER), Toast.LENGTH_SHORT).show();
...
//        }
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        if (id == R.id.nav_dashboard) {
            ...
            fragment = new TransaksiFragment(0);
...
//        }
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.screen_area, fragment, "Main")
                .addToBackStack("Main")
                .commit();
    ...
    private void loadProfile(String kd_user){
        StringRequest stringRequest = new StringRequest( Request.Method.GET, baseUrl + "CheckRegisteredUser/GetRegisteredUser?KODE_USER=" + kd_user,
            new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    try {
                        final JSONObject userprofile = new JSONObject(response);
                        namaUser.setText(userprofile.getString( "NAMA_USER" ) );
                        urlGambar =  userprofile.getString( "FOTO_FILEPATH");
