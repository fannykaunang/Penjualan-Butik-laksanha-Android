...
public class DetailBarangActivity extends AppCompatActivity {
    ...
    private static final String API_URL = "PenjualanStokBarang/GetByID?id=";
    Intent intent;
...
//                            Toast.makeText(DetailBarangActivity.this, jsonArray.length(), Toast.LENGTH_SHORT).show();
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                if (jo.getInt( "JUMLAH_DATA" )==0){
                                    ...
                                    setTidakAdaGambar(jo.getString( "NAMA_BARANG" ));
                                }else{
                                    txtNamaBarangDetail.setText(  jo.getString( "NAMA_BARANG" ));
                                    txtNamaKategoriDetailBarang.setText( jo.getString( "KATEGORI_BARANG" ));
                                    txtDetailHargaBeli.setText( "Rp. "+jo.getString( "HARGA_BELI" ) );
                                    txtDetailHargaJual.setText( "Rp. "+jo.getString( "HARGA_JUAL" ) );
                                    txtDetailStok.setText(  jo.getString( "STOK" )  );
                                    if (jo.getString( "BARCODE_FILEPATH" ).equals( "" )){
                                        adaGambar.setVisibility( View.GONE );
                                        tidakAdaGambar.setVisibility( View.VISIBLE );
                                        setTidakAdaGambar(jo.getString( "NAMA_BARANG" ));
                                    }else{
                                        ...
                                        Glide.with(DetailBarangActivity.this)
                                                ...
                                                .load(( jo.getString( "BARCODE_FILEPATH" )  ))
                                                .error(R.drawable.noimage_icon_128)
                            ...
                            e.printStackTrace();
                            Toast.makeText(DetailBarangActivity.this, "Periksa koneksi & coba lagi" + e.toString(), Toast.LENGTH_SHORT).show();
                        }
