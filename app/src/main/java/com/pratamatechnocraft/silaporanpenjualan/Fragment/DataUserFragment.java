...
public class DataUserFragment extends Fragment {
    ...
    private void loadDataUser(){
        ...
        StringRequest stringRequest = new StringRequest( Request.Method.GET, baseUrl + API_URL,// + user.get( sessionManager.KD_USER ),
...
//                        JSONObject jsonObject = new JSONObject(response);
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String level_user;
                            if (jo.getString( "ACCESS_NUMBER" ).equals( "1" )){
                                level_user="Owner";
                            }else{
                                level_user="Kasir";
                            }
...
//                                        userobject.getString( "NAMA_USER" )+" "+userobject.getString( "nama_belakang" ),
