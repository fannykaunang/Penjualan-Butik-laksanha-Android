...
public class ProfileFragment extends Fragment {
    ...
    private static final String API_URL_LOAD = "CheckRegisteredUser/GetRegisteredUser?KODE_USER=";
            ...
            new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        txtNamaUserProfile.setText(userprofile.getString( "NAMA_USER" ) );
                        textnama.setText(userprofile.getString( "NAMA_USER" ) );
                        txtNamaDepan.setText( userprofile.getString( "NAMA_USER" ));
                        txtNamaBelakang.setText( userprofile.getString( "NAMA_USER" ));
                        if (userprofile.getString( "LEVEL_USER" ).equals("Administrator")) {
//                        if(Integer.parseInt( userprofile.getString( "LEVEL_USER" ) )==0){
                        ...
                        textnotelp.setText( userprofile.getString( "EMAIL" ) );
                        textalamat.setText(  userprofile.getString( "EMAIL" )  );
                        urlGambarProfile =  userprofile.getString( "FOTO_FILEPATH");
                        profile_image.setOnClickListener( new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent i = new Intent(getContext(), ZoomFotoProfile.class);
                                i.putExtra("FOTO_FILEPATH", urlGambarProfile);
                                try {
                        ...
                        btnUbahPass.setOnClickListener( new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                try {
                                    DialogFormUbahPass(String.valueOf( userprofile.getString( "SANDI" )  ));
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                            }
