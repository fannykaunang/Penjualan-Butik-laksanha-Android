...
public class AdapterRecycleViewDataUser extends RecyclerView.Adapter<AdapterRecycleViewDataUser.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (!listItemDataUser.getFotoUser().equals("")){
            ...
            Glide.with(context)
                    ...
                    .load(listItemDataUser.getFotoUser())
                    .error(R.drawable.default_foto_user)
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        private TextView txtNamaUser, txtNoTelp, txtLevelUser, hurufDepanDataUser;
        private CardView cardViewDataUser;
        private CircleImageView fotoDataUser, fotoDataUser1;
        private RelativeLayout adaGambarUser, tidakAdaGambarUser;

        public ViewHolder(View itemView) {
            super(itemView);
            txtNamaUser = itemView.findViewById(R.id.txtNamaUser);
            txtNoTelp = itemView.findViewById(R.id.txtNoTelp);
            txtLevelUser = itemView.findViewById(R.id.txtLevelUser);
            cardViewDataUser = itemView.findViewById(R.id.cardViewDataUser);
            hurufDepanDataUser = itemView.findViewById(R.id.hurufDepanUser);
            fotoDataUser = itemView.findViewById( R.id.fotoDataUser );
            fotoDataUser1 = itemView.findViewById( R.id.fotoDataUser1 );
            adaGambarUser = itemView.findViewById( R.id.adaGambarUser );
            tidakAdaGambarUser = itemView.findViewById( R.id.tidakAdaGambarUser );
        }
    }
}
